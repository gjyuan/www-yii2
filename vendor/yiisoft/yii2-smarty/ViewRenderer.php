...
class ViewRenderer extends BaseViewRenderer
{
    ...
    public $pluginDirs = [];
    /**
     * @var string outsize samrty plugins dir
     */
    public $plugins_extension_dir = "@smarty_plugins_extension";
    /**
    ...
    public function init()
    {
        ...
        //添加插件的扩展的路径
        $this->smarty->addPluginsDir(Yii::getAlias($this->plugins_extension_dir));
