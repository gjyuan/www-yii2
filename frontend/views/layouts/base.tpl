...
<body>
    ...
    <script type="text/javascript" src="{fe static='js/base/labjs.min.js'}"></script>
    <script type="text/javascript">
        $LAB.script("{fe static='js/base/jquery.min.js'}").wait()
            .script("{fe static='plugins/bootstrap/js/bootstrap.min.js'}").wait()
            .script("{fe static='js/common/common.js'}");
    </script>
